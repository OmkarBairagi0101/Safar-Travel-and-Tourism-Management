...
<html>
<head>
<title>Safar | Admin manage Bookings</title>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Bookings</h2>
						...
						<tbody>
<?php $sql = "SELECT booking.BookingId as bookid,users.FullName as fname,users.MobileNumber as mnumber,users.EmailId as email,tourpackages.PackageName as pckname,booking.PackageId as pid,booking.FromDate as fdate,booking.ToDate as tdate,booking.Comment as comment,booking.status as status,booking.CancelledBy as cancelby,booking.UpdationDate as upddate from users join  booking on  booking.UserEmail=users.EmailId join tourpackages on tourpackages.PackageId=booking.PackageId";
$query = $dbh -> prepare($sql);
$query->execute();
