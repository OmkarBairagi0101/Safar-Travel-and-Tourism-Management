...
$sql = "UPDATE enquiry SET Status=:status WHERE  id=:eid";
...
<html>
<head>
<title>Safar | Admin manage Issues</title>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Issues</h2>
						...
						<tbody>
<?php $sql = "SELECT issues.id as id,users.FullName as fname,users.MobileNumber as mnumber,users.EmailId as email,issues.Issue as issue,issues.Description as Description,issues.PostingDate as PostingDate from issues join users on users.EmailId=issues.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
